...
save(survival_data, file="Z:/Strategic Analytics/Projects 2024/NHSE Community Strategy/survival_analysis.RData")
...
```{r, fig.height=8, fig.width=8}
 ...
 mortality<-furniture::table1(deaths_data_2223|>
  ...
  mortality|>
    ...
    bold(i=12, bold = TRUE, part="body")|>
    bold(i=20, bold = TRUE, part="body")|>
    bold(i=32, bold = TRUE, part="body")|>
...
p1<-plot_readmissions_over_time(survival_data|>
  filter(died_before_readmission_28days==0), readmit_28days, "Readmission within 28 days")
p2<-plot_readmissions_over_time(survival_data|>
  filter(died_before_readmission_1yr==0), readmit_1yr, "Readmission within 1 year")
...
survived_to_readmission<-survival_data_2223|>
  filter(died_before_readmission_1yr==0)
 
 readmit<-furniture::table1(survived_to_readmission|>
   filter(cohort=="falls")|>mutate(cohort="Total"), 
   sex, age_range, ethnicity, imd_decile, cohort,
         splitby= ~factor(mortality_1yr)*cohort, 
         row_wise=TRUE,
   ...
   filter(.!="")|>
   rename(`Falls`=`1`)|>
   full_join(furniture::table1(survived_to_readmission|>
   filter(cohort=="frail")|>mutate(cohort="Total"), 
   sex, age_range, ethnicity, imd_decile, cohort,
         splitby= ~factor(mortality_1yr)*cohort, 
         row_wise=TRUE,
